...
// Data semua gift, sesuaikan gambar & audio
const gifts = [
  {
    id: 'sayangi-aku',
    name: 'Sayangi Aku',
    ...
    { id: 'tanda-cinta', name: 'Tanda Cinta', coins: 99, img: 'https://p16-webcast.tiktokcdn.com/img/alisg/webcast-sg/resource/582475419a820e0b0dbc964799b6146e.png~tplv-obj.webp', audio: 'audio/hay.mp3' },
  {
    ...
    audio: 'audio/donat.mp3' // bisa ditambah
  }
];

// Generate tombol gift
gifts.forEach(gift => {
...
function showGift(giftId) {
  ...
  if (gift.audio) {
    ...
    // Hilangkan gift display otomatis saat musik selesai
